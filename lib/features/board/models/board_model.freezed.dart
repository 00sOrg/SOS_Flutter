...
abstract class $BoardModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String title, String? image, String content});
}
...
class _$BoardModelImpl implements _BoardModel {
  ...
  @override
  String toString() {
    return 'BoardModel(id: $id, title: $title, image: $image, content: $content)';
  }
...
abstract class _BoardModel implements BoardModel {
  const factory _BoardModel(
      ...
      final String? image,
      required final String content}) = _$BoardModelImpl;
